...
//
//岩切用メモ: 重み変更する必要あり
execSync(`cd ${dnDir} && ./darknet detector test cfg/obj.data cfg/yolov3-tiny.cfg backup/yolov3-tiny_12000.weights -thresh 0.5 ${__dirname}/${req.file.filename} && cp predictions.jpg ${__dirname}/predictions.jpg`);
