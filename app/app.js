...
//
//岩切用メモ: 重み変更する必要あり
execSync(`cd ${dnDir} && ./darknet detector test cfg/obj.data cfg/yolov3-voc.cfg backup/yolov3-voc_6000.weights ${__dirname}/${req.file.filename} && cp predictions.jpg ${__dirname}/predictions.jpg`);
